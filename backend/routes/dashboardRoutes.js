...
router.get("/dashboard", requireAdminAuth, requirePermission("dashboard.view"), async (req, res) => {
  ...
  res.json({ success: true, stats: { weddings, photos, inquiries, newInquiries, bookings, upcomingBookings, testimonials, publishedTestimonials, packages, services }, recentInquiries, upcomingBookings: upcoming, activity });
});
